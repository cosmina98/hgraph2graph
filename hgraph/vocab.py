...
COMMON_ATOMS = [('B', 0), ('B', -1), ('Br', 0), ('Br', -1), ('Br', 2), ('C', 0), \
    ('C', 1), ('C', -1), ('Cl', 0), ('Cl', 1), ('Cl', -1), ('Cl', 2), ('Cl', 3), ('F', 0),\
         ('F', 1), ('F', -1), ('I', -1), ('I', 0), ('I', 1), ('I', 2), ('I', 3), ('N', 0), \
            ('N', 1), ('N', -1), ('O', 0), ('O', 1), ('O', -1), ('P', 0), ('P', 1), ('P', -1), \
                ('S', 0), ('S', 1), ('S', -1), ('Se', 0), ('Se', 1),\
                     ('Se', -1), ('Si', 0), ('Si', -1),\
        ('Na',-1),('Na',0),('Na',1),  ('H',-1),('H',0),('H',1) ,('Hg',-1),('Hg',0),  ('Pt',-1),('Pt',0), \
            ('Cu',-1),('Cu',0), ('As',-1),('As',0),('Mn',-1),('Mn',0), ('Sn',-1),('Sn',0),\
                    ('Li',-1),('Li',0),('Sb',-1),('Sb',0),('Cr',-1),('Cr',0),\
                        ('Zn',-1),('Zn',0),('Fe',-1),('Fe',0),('Ru',-1),('Ru',0),('Au',-1),('Au',0)]
